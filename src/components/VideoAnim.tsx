  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        ...
        .shared-float { animation: sharedFloat 4.5s ease-in-out infinite; }

        @keyframes sharedGlow {
          0%,100% { text-shadow: 0 0 0 rgba(255,210,160,0); }
          50% { text-shadow: 0 0 14px rgba(255,210,160,0.8); }
        }
        .emoji-shared { animation: sharedGlow 3.5s ease-in-out infinite; }
        ...
        .halo-bg {
          ...
          width: 60%;
          height: 80%;
          background: radial-gradient(circle, rgba(255,230,210,0.35) 0%, rgba(255,255,255,0) 70%);
          filter: blur(80px);
        }
        ...
        .particles {
          ...
          width: 100%;
          height: 100%;
          background-image: radial-gradient(rgba(255,230,200,0.4) 1px, transparent 1px);
